...
/rest/namespace/
    x-emc-uid: 0e069767430c4d37997853b058eb0af8/EMC007A49DEEA84C837E::::
    * About to connect() to accesspoint.emccis.com port 80 (#0)
*   Trying 208.48.63.13... * connected
    * Connected to accesspoint.emccis.com (208.48.63.13) port 80 (#0)
> GET /rest/namespace/ HTTP/1.1
    Host: accesspoint.emccis.com
    Accept: *\/*
x-emc-uid: 0e069767430c4d37997853b058eb0af8/EMC007A49DEEA84C837E
date:Sun, 3 Jan 2010 21:10:01 GMT
x-emc-signature:rJQEPV/mITtShgSxcqdyzMr5z28=
*/
int more();
int main() { 
...
int more(){
    ...
    int val = init(user_id, key, endpoint);
    
    //const char *object_id = create_object(NULL, NULL,NULL);
    const char *object_id = list_objects();
